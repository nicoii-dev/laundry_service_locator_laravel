                ...
                <tbody>
                    <tr>
                        <td style="font-family: 'Helvetica Neue',sans-serif;color:#999;font-size:13px;line-height:1.6;padding:20px 0" align="center">
                            ...
                            >
                                <img width="150" alt="{{env('APP_NAME')}}" src="https://cdn-icons-png.flaticon.com/512/7843/7843946.png" style="height:auto;line-height:100%;outline:none;text-decoration:none;max-width:400px!important;border:0">
                                <p style="font-size: 28px;color: white; font-family:monospace;">Laundry Service Locator</p>
                            </div>
                        </td>
                    </tr>
                </tbody>
